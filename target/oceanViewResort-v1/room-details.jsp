        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-lg rounded-4 p-4 sticky-top" style="top: 100px;">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12">
                        <button class="btn btn-primary w-100 py-3 fw-bold rounded-pill" onclick="checkAvailability()">
                ...
                <div id="availabilityResults" class="d-none animate__animated animate__fadeIn">
                    ...
                    <div class="row g-2 mb-4" id="availableRooms">
                        <div class="col-4">
                    ...
                    <div class="bg-light p-3 rounded-3 mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            ...
                            <span class="fw-bold text-dark" id="numNights"></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mt-2">
