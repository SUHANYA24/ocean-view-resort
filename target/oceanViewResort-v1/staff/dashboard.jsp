            ...
            <div class="card border-0 shadow-sm p-4 border-bottom border-primary border-5 rounded-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0"><%= request.getAttribute("arrivals") %></h2>
                    </div>
            ...
            <div class="card border-0 shadow-sm p-4 border-bottom border-warning border-5 rounded-4">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0"><%= request.getAttribute("departures") %></h2>
                    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <%
List<RoomBooking> guests = (List<RoomBooking>)request.getAttribute("liveGuests");

if(guests != null){
for(RoomBooking g : guests){
                    %>

                    <tr>

                        <td class="ps-4 fw-bold text-primary">
                            <%= g.getRoom().getRoomNumber() %>
                        </td>
