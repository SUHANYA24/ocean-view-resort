...
<head>
    ...
    <style>
        ...
        .navbar { background: rgba(255, 255, 255, 0.95); transition: 0.3s; }
        .hero-section {
        ...
        .btn-primary { background-color: #0077b6; border: none; padding: 12px 30px; border-radius: 8px; }
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link px-3" href="#">Rooms</a></li>
                    <li class="nav-item"><a class="nav-link px-3 text-dark fw-semibold" href="login.jsp">Login</a></li>
                    <li class="nav-item ms-lg-3">
                        <a class="btn btn-primary" href="register.jsp">Join Now</a>
                    </li>
                </ul>
            </div>
        </div>
